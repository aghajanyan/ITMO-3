...
VDS_r (usage_r) 0 prop IQR.csv датасет основанный на VDS_r, включающий следующие индикаторы 'ITusage_s', 'AIusage_s', 'BDusage_s' (322 примера, мёрдж через 'region'/'year')

factoriescap_r (costs_r) 0 prop IQR.csv - датасет основанный на factoriescap_r, включающий следующие индикаторы: 'ITcosts_s', 'skvozcosts_s', 'trainingcosts_s' (329 пример, мёрдж через 'region'/'year')
